...
//                             <option 
//                               key={`${rate.from_code}-${rate.bank_id}`} 
//                               value={rate.from_code}
//                             >
//                               {rate.to_currency_name} ({rate.from_code}) 
...
//                     <div className="p-3 bg-base-200 rounded min-h-[42px]">
//                       {employee.currency}
//                       {currencyRates.find(c => c.from_code === employee.currency) && (
//                         <span className="text-sm text-gray-500 ml-2">
//                           {currencyRates.find(c => c.from_code === employee.currency)?.to_currency_name}
//                         </span>
//                       )}
//                     </div>
//                   )}
...
//                         index === self.findIndex(r => r.from_code === rate.from_code)
//                       )
//                       .map(rate => (
//                         <option key={rate.from_code} value={rate.from_code}>
//                           {rate.to_currency_name} ({rate.from_code})
//                         </option>
//                       ))
//                     }
...
//                     {currencyRates.find(c => c.from_code === employee.bank_currency) && (
//                       <span className="text-sm text-gray-500 ml-2">
//                         ({currencyRates.find(c => c.from_code === employee.bank_currency)?.to_currency_name})
//                       </span>
//                     )}
//                   </div>
//                 )}
