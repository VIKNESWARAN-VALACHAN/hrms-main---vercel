                ...
                {bulkTool === 'time' && (
                  <div className="card bg-base-200 p-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end gap-3">
                      ...
                      <div className="flex gap-2">
                        <button className="btn btn-primary" onClick={applyBulkTime}>Apply</button>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {bulkTool === 'template' && (
                  <div className="card bg-base-200 p-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end gap-3">
                      ...
                      <div className="flex gap-2">
                        <button className="btn btn-primary" onClick={applyBulkTemplate} disabled={!templateToApply}>Apply</button>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {bulkTool === 'pattern' && (
                  <div className="card bg-base-200 p-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end gap-3">
                      ...
                      <div className="flex gap-2">
                        <button className="btn btn-primary" onClick={applyBulkPattern} disabled={!patternToApply}>
                          Apply to {bulkScope === 'page' ? 'current page employees' : bulkScope === 'all' ? 'all filtered employees' : 'selected employees'}
                        </button>
                      </div>
                    </div>
