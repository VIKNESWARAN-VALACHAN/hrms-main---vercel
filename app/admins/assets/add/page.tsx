      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-base-content">Add New Asset</h1>
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <form onSubmit={handleSubmit} className="space-y-8">
              {/* Basic Information Section */}
              <section>
                <h2 className="text-xl font-semibold text-base-content mb-6 pb-2 border-b border-base-300">
                  Basic Information
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="form-control">
                    ...
                    <select
                      name="model_id"
                      className={`select w-full ${!form.brand_id ? 'select-disabled' : 'select-bordered'}`}
                      value={form.model_id}
                      onChange={handleChange}
                      required
                      disabled={!form.brand_id}
                    ...
                    {!form.brand_id && (
                      <label className="label">
                        <span className="label-text-alt text-warning">Please select a brand first</span>
                      </label>
                    )}
                  </div>
                </div>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-semibold">VPN ID</span>
                    </label>
                    <input
                      type="text"
                      name="vpn_id"
                    ...
                    />
                    <label className="label">
                      <span className="label-text-alt">Enter the VPN account ID associated with this asset</span>
                    </label>
                  </div>
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-semibold">Deep Freeze ID</span>
                    </label>
                    <input
                      type="text"
                      name="deep_freeze_id"
                    ...
                    />
                    <label className="label">
                      <span className="label-text-alt">Enter the Deep Freeze account ID associated with this asset</span>
                    </label>
                  </div>
                </div>
              </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="form-control">
                    ...
                    <label className="label">
                      <span className="label-text-alt">
                        {form.category_id 
                          ? `Selected: ${categories.find(c => String(c.id) === form.category_id)?.name}`
                  ...
                  <div className="form-control">
                    ...
                    <label className="label">
                      <span className="label-text-alt">
                        {form.unit_id 
                          ? `Selected: ${units.find(u => String(u.id) === form.unit_id)?.name}`
                          : 'Auto-populated when product is selected'
                        }
                      </span>
                    </label>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-semibold">Invoice Reference</span>
                    </label>
                    <input
                      type="text"
                      name="invoice_ref"
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-semibold">Warranty Expiry</span>
                    </label>
                    <input
                      type="date"
                      name="warranty_expiry"
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-semibold">Assigned Department</span>
                    </label>
                    <select
                      name="assigned_department"
                      className="select select-bordered w-full"
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-semibold">Assignment Start Date</span>
                    </label>
                    <input
                      type="date"
                      name="assignment_start_date"
...
<section>
  ...
  <div className="form-control">
    ...
    <textarea
      name="description"
      className="textarea textarea-bordered h-24 input-bordered w-full"
      value={form.description}
      onChange={handleChange}
      placeholder="Enter any additional details about the asset..."
    />
