...
// // Add the missing fetchEmployeeBasedFilters function
// const fetchEmployeeBasedFilters = async () => {
//   try {
//     const employeesRes = await axios.get(`${API_BASE_URL}/api/admin/employees`, {
//       headers: {
//         Authorization: `Bearer ${localStorage.getItem('hrms_token')}`
//       }
//     });
    
//     const employeesData: any[] = Array.isArray(employeesRes.data) ? employeesRes.data : [];
//     console.log('Employees data for filters:', employeesData);

//     // Extract employment types from employees
//     const employmentTypes = [...new Set(employeesData
//       .map((emp: any) => {
//         if (typeof emp === 'string') return null;
//         return emp.employment_type || emp.employmentType || emp.type;
//       })
...
//     console.log('Filter employment types set:', employmentTypes);

//     // Extract nationalities from employees
//     const nationalities = [...new Set(employeesData
//       .map((emp: any) => {
//         if (typeof emp === 'string') return null;
//         return emp.nationality || emp.country;
//       })
//       .filter((nationality: any): nationality is string => 
//         nationality !== null && nationality !== undefined && nationality !== ''
//       ))].sort();
    
//     // If no nationalities found in employee data, use defaults
//     if (nationalities.length === 0) {
//       setFilterNationalities(['Malaysian', 'Singaporean', 'Indonesian', 'Chinese', 'Indian', 'Other']);
//     } else {
//       setFilterNationalities(nationalities);
//     }
//     console.log('Filter nationalities set:', nationalities);

//     // Extract job levels from employees
//     const jobLevels = [...new Set(employeesData
//       .map((emp: any) => {
//         if (typeof emp === 'string') return null;
//         return emp.job_level || emp.level || emp.grade;
//       })
//       .filter((level: any): level is string => 
//         level !== null && level !== undefined && level !== ''
//       ))].sort();
    
//     setFilterJobLevels(jobLevels);
//     console.log('Filter job levels set:', jobLevels);

//   } catch (error) {
//     console.error('Error fetching employee-based filters:', error);
//     // Set default values
//     setFilterEmploymentTypes(['Full-time', 'Part-time', 'Contract', 'Intern', 'Temporary']);
//     setFilterNationalities(['Malaysian', 'Singaporean', 'Indonesian', 'Chinese', 'Indian', 'Other']);
//     setFilterJobLevels(['Manager', 'Executive', 'Senior Executive', 'Junior Executive']);
//   }
// };
...
//   // Filtered leave requests
// // Filtered leave requests with search
