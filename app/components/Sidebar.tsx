...
//   // Use permission hook instead of just role
//   const { hasAccess, can, loading: permissionsLoading } = useModuleAccess();
...
//           {/* Announcement - Permission based */}
//           {hasAccess('Announcement') && (
//             <li>
//               <Link
//                 href="/announcements"
//                 className={`px-4 py-3 rounded-lg transition-all duration-300 ${
...
//           {/* Employee Management - Complex permissions */}
//           {(hasAccess('Employee') || hasAccess('Employee.View')) && (
//             <li>
//               <button
//                 onClick={() => toggleMenu("manage-employee")}
//                 aria-expanded={lastOpenedMenu === "manage-employee"}
...
//                   </svg>
//                   <span>
//                     {hasAccess('Employee.View') && !hasAccess('Employee.Create') ? "My Profile" : "Employee"}
//                   </span>
//                 </div>
//                 <svg xmlns="http://www.w3.org/2000/svg" className={caretCls(lastOpenedMenu === "manage-employee")} fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
...
//               <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "manage-employee" ? "block" : "hidden"}`}>
//                 {/* Always show profile view */}
//                 {(hasAccess('Employee.View') || hasAccess('Employee')) && (
//                   <li>
//                     <Link
//                       href="/employees"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                       onClick={handleMobileNavigation}
//                     >
//                       {hasAccess('Employee.Create') ? "View Employees" : "My Profile"}
//                     </Link>
//                   </li>
//                 )}
                
//                 {/* Only show create for those with create permission */}
...
//                 {/* Disciplinary types - specific permission */}
...
//           {/* Company Management - Admin + specific permissions */}
//           {hasAccess('Company') && (
//             <li>
//               <button
//                 onClick={() => toggleMenu("manage-company")}
...
//           {/* Asset Management - Different views based on permissions */}
//           {hasAccess('AssetManagement') && (
//             <li>
//               <button
//                 onClick={() => toggleMenu("asset-management")}
//                 aria-expanded={lastOpenedMenu === "asset-management"}
...
//               <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "asset-management" ? "block" : "hidden"}`}>
//                 {/* Admin/Manager Views */}
//                 {(hasAccess('AssetManagement.View') || hasAccess('AssetManagement.Manage')) && (
//                   <>
//                     <li>
//                       <Link
//                         href="/admins/assets"
...
//                 {/* Approval permission */}
//                 {hasAccess('AssetManagement.Approve') && (
//                   <li>
//                     <Link
//                       href="/admins/assets/approval"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                 {hasAccess('AssetManagement.MyAssets') && (
//                   <>
//                     <li>
//                       <Link
//                         href="/assets"
...
//           {/* Feedback Management (Admin) */}
//           {hasAccess('Feedback') && hasAccess('Feedback.Manage') && (
//             <li>
//               <button
//                 onClick={() => toggleMenu("admin-panel")}
//                 aria-expanded={lastOpenedMenu === "admin-panel"}
...
//           {/* PAYROLL - Complex nested permissions */}
//           {hasAccess('Payroll') && (
//             <li>
//               <button
//                 onClick={() => toggleMenu("payroll-management")}
...
//                       </button>
//                       <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-payitems"] ? "block" : "hidden"}`}>
//                         {/* Show allowances and deductions if user has Payroll.Setup access */}
//                         <li>
//                           <Link
//                             href="/master-data/allowances"
//                             className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                       </button>
//                       <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-statutory"] ? "block" : "hidden"}`}>
//                         {/* Show all statutory items if user has Payroll.Setup access */}
//                         <li>
//                           <Link
//                             href="/master-data/epf"
//                             className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                       </button>
//                       <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-config"] ? "block" : "hidden"}`}>
//                         {/* Show all config items if user has Payroll.Setup access */}
//                         <li>
//                           <Link
//                             href="/admins/payroll-config-allowance"
//                             className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//           {/* Claims - Different views */}
//           {hasAccess('Claims') && (
//             <li>
//               {hasAccess('Claims.Manage') ? (
...
//               <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "master-data" ? "block" : "hidden"}`}>
//                 {/* Feedback System masters - Show if user has MasterData access */}
//                 <li className="mt-4 mb-1 pl-2 text-xs font-semibold text-blue-200 uppercase">Feedback System</li>
//                 <li>
//                   <Link
//                     href="/admins/masters/sections"
...
// {(hasAccess('Admin') || hasAccess('Admin.View') || hasAccess('Admin.Create') || hasAccess('Admin.Settings')) && (
//   <li>
//     <button
//       onClick={() => toggleMenu("manage-admin")}
//       aria-expanded={lastOpenedMenu === "manage-admin"}
//       className={`w-full flex items-center py-3 px-4 justify-between rounded-lg transition-all duration-300 ${
//         pathname.startsWith("/admins") || pathname.startsWith("/admin-settings") || pathname.startsWith("/admin/permissions")
//           ? "bg-blue-600 text-white font-semibold shadow-md"
//           : "hover:bg-blue-500"
//       }`}
//     >
...
//     <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "manage-admin" ? "block" : "hidden"}`}>
//       {/* Always show these links if user has ANY Admin permission */}
//       <li>
//         <Link
//           href="/admins"
//           className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//           className={`py-2 px-4 rounded-lg transition-all duration-300 ${
//             pathname === "/admin/permissions" ? "bg-blue-500 text-white font-semibold" : "hover:bg-blue-500"
//           }`}
//           onClick={handleMobileNavigation}
//         >
//           Permission Manager
...
//           href="/admin-settings"
//           className={`py-2 px-4 rounded-lg transition-all duration-300 ${
//             pathname.startsWith("/admin-settings") ? "bg-blue-500 text-white font-semibold" : "hover:bg-blue-500"
//           }`}
//           onClick={handleMobileNavigation}
//         >
//           Admin Settings
...
export default function Sidebar({ onCollapseChange }: SidebarProps) {
  ...
  const shouldShow = (module: string, requiredPermission?: string) => {
    // If custom permissions are configured, use them
    if (hasCustomPermissions) {
      return requiredPermission ? can(requiredPermission) : hasAccess(module);
    }
    
    // Fallback to role-based access
    switch (module) {
      case 'Announcement':
        return true; // Everyone can see announcements
      case 'Leave':
        return true; // Everyone can see leave
      case 'Attendance':
        return true; // Everyone can see attendance
      case 'Employee':
      ...
      case 'AssetManagement':
        return true; // All roles have some asset access
      case 'Feedback':
        return true; // All roles have feedback access
      case 'Payslip':
        return role !== "admin"; // Staff only
      case 'Payroll':
        return role === "admin";
      case 'Claims':
        return true; // All roles have claims access
      case 'MasterData':
        return role === "admin";
      case 'Configuration':
        return role === "admin";
        ...
        <ul className="menu menu-vertical bg-transparent w-full space-y-1 mt-4 flex-grow px-2">
          ...
          {shouldShow('Company') && (
            <li>
              ...
              <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "manage-company" ? "block" : "hidden"}`}>
                {/* View Companies - always show if company module is accessible */}
                <li>
                  <Link
                    href="/companies"
                    className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                ...
                {/* Add Company - only for admin or with create permission */}
                {(!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('Company.Create')) ? (
                  <li>
                    <Link
                      href="/companies/add"
                      className={`py-2 px-4 rounded-lg transition-all duration-300 ${
          ...
          {shouldShow('AssetManagement') && (
            <li>
              ...
              <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "asset-management" ? "block" : "hidden"}`}>
                {/* Admin/Manager Views */}
                {(!hasCustomPermissions && (role === "admin" || role === "manager")) || 
                 (hasCustomPermissions && (hasAccess('AssetManagement.View') || hasAccess('AssetManagement.Manage'))) ? (
                  <>
                    <li>
                      <Link
                        href="/admins/assets"
                ...
                {/* Approval permission */}
                {(!hasCustomPermissions && (role === "admin" || role === "manager")) || 
                 (hasCustomPermissions && hasAccess('AssetManagement.Approve')) ? (
                  <li>
                    <Link
                      href="/admins/assets/approval"
                      className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                ...
                {/* Employee self-service */}
                {(!hasCustomPermissions && role !== "admin" && role !== "manager") || 
                 (hasCustomPermissions && hasAccess('AssetManagement.MyAssets')) ? (
                  <>
                    <li>
                      <Link
                        href="/assets"
          ...
          {shouldShow('Feedback') && 
           ((!hasCustomPermissions && role === "admin") || 
            (hasCustomPermissions && hasAccess('Feedback.Manage'))) && (
            <li>
              <button
                onClick={() => toggleMenu("admin-panel")}
                aria-expanded={lastOpenedMenu === "admin-panel"}
          ...
          {shouldShow('Payroll') && (
            <li>
              ...
              <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "payroll-management" ? "block" : "hidden"}`}>
                {/* Run */}
                {(!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('Payroll.Run')) ? (
                  <li>
                    <Link
                      href="/admins/payrolls"
                      className={`py-2 px-4 rounded-lg flex items-center gap-2 transition-all duration-300 ${
                ...
                {/* Setup label */}
                {((!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('Payroll.Setup'))) && (
                  <>
                    <li className="mt-2 mb-1 pl-2 text-xs font-semibold text-blue-200 uppercase">Setup</li>
                    ...
                    <li>
                      ...
                      <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-payitems"] ? "block" : "hidden"}`}>
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.Allowances')) ? (
                          <li>
                            <Link
                              href="/master-data/allowances"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.Deductions')) ? (
                          <li>
                            <Link
                              href="/master-data/deductions"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                    ...
                    <li>
                      ...
                      <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-statutory"] ? "block" : "hidden"}`}>
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.EPF')) ? (
                          <li>
                            <Link
                              href="/master-data/epf"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.SOCSO')) ? (
                          <li>
                            <Link
                              href="/master-data/socso"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.EIS')) ? (
                          <li>
                            <Link
                              href="/master-data/eis"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.PCB')) ? (
                          <li>
                            <Link
                              href="/master-data/pcb"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.TaxReliefs')) ? (
                          <li>
                            <Link
                              href="/master-data/reliefs"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                    ...
                    <li>
                      ...
                      <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-config"] ? "block" : "hidden"}`}>
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.AllowanceMapping')) ? (
                          <li>
                            <Link
                              href="/admins/payroll-config-allowance"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.DeductionMapping')) ? (
                          <li>
                            <Link
                              href="/admins/payroll-config-deduction"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.Config')) ? (
                          <li>
                            <Link
                              href="/admins/payroll-config"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.PolicyAssignment')) ? (
                          <li>
                            <Link
                              href="/admins/payroll-policy-assignment"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.BankCurrency')) ? (
                          <li>
                            <Link
                              href="/admins/bank-currency"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.Overtime')) ? (
                          <li>
                            <Link
                              href="/admins/overtime"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                    ...
                    <li>
                      ...
                      <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-overrides"] ? "block" : "hidden"}`}>
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.EmployeeAllowances')) ? (
                          <li>
                            <Link
                              href="/admins/employee-allowances"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.EmployeeDeductions')) ? (
                          <li>
                            <Link
                              href="/admins/employee-deductions"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                        ...
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.EmployeeReliefs')) ? (
                          <li>
                            <Link
                              href="/admins/employee-reliefs"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                    ...
                    <li>
                      ...
                      <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-claims"] ? "block" : "hidden"}`}>
                        {(!hasCustomPermissions && role === "admin") || 
                         (hasCustomPermissions && hasAccess('Payroll.ClaimBenefits')) ? (
                          <li>
                            <Link
                              href="/admins/claim"
                              className={`py-2 px-4 rounded-lg transition-all duration-300 ${
          ...
          {shouldShow('Claims') && 
           ((!hasCustomPermissions && role !== "admin") || 
            (hasCustomPermissions && !hasAccess('Claims.Manage'))) && (
            <li>
              <Link
                href="/claims"
                className={`py-2 px-4 flex items-center rounded-lg transition-all duration-300 ${
          ...
          {shouldShow('MasterData') && (
            <li>
              ...
              <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "master-data" ? "block" : "hidden"}`}>
                {/* Feedback System masters */}
                {((!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('MasterData.Feedback'))) && (
                  <>
                    <li className="mt-4 mb-1 pl-2 text-xs font-semibold text-blue-200 uppercase">Feedback System</li>
                    <li>
                      <Link
                ...
                {/* Asset masters (under Master Data) */}
                {((!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('MasterData.Asset'))) && (
                  <>
                    <li className="mt-4 mb-1 pl-2 text-xs font-semibold text-blue-200 uppercase">Asset Management</li>
                    <li>
                      <Link
                ...
                {/* System */}
                {((!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('MasterData.System'))) && (
                  <>
                    <li className="mt-4 mb-1 pl-2 text-xs font-semibold text-blue-200 uppercase">System</li>
                    <li>
                      <Link
          ...
          {shouldShow('Configuration') && (
            <li>
              ...
              <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "config-management" ? "block" : "hidden"}`}>
                {((!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('Configuration.Holiday'))) && (
                  <li>
                    <Link
                      href="/config/holiday"
                      className={`py-2 px-4 rounded-lg transition-all duration-300 ${
          ...
          {shouldShow('Admin') && (
            <li>
              ...
              <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "manage-admin" ? "block" : "hidden"}`}>
                {((!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('Admin.View'))) && (
                  <li>
                    <Link
                      href="/admins"
                      className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                ...
                {((!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('Admin.Create'))) && (
                  <li>
                    <Link
                      href="/admins/add"
                      className={`py-2 px-4 rounded-lg transition-all duration-300 ${
                ...
                {((!hasCustomPermissions && role === "admin") || 
                 (hasCustomPermissions && hasAccess('Admin.Permissions'))) && (
                  <li>
                    <Link
                      href="/admins/permissions"
                      className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//     // If custom permissions are configured, use them
//     if (hasCustomPermissions) {
//       return requiredPermission ? can(module, requiredPermission) : hasAccess(module);
//     }
...
//                   <span>
//                     {(!hasCustomPermissions && role === "employee") || 
//                      (hasCustomPermissions && hasAccess('Employee') && !can('Employee', 'create')) 
//                      ? "My Profile" : "Employee"}
//                   </span>
//                 </div>
//                 <svg xmlns="http://www.w3.org/2000/svg" className={caretCls(lastOpenedMenu === "manage-employee")} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
//                 {/* Add New Employee - only for admin or with create permission */}
//                 {(!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && can('Employee', 'create')) ? (
//                   <li>
//                     <Link
//                       href="/employees/add"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                 {/* Disciplinary types - only for admin or with disciplinary permission */}
//                 {(!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && can('Employee', 'disciplinary')) ? (
//                   <li>
//                     <Link
//                       href="/master-data/disciplinary_types"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                 {/* Add Company - only for admin or with create permission */}
//                 {(!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && can('Company', 'create')) ? (
//                   <li>
//                     <Link
//                       href="/companies/add"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                 {/* Admin/Manager Views */}
//                 {(!hasCustomPermissions && (role === "admin" || role === "manager")) || 
//                  (hasCustomPermissions && (hasAccess('AssetManagement') || can('AssetManagement', 'manage'))) ? (
//                   <>
//                     <li>
//                       <Link
//                         href="/admins/assets"
...
//                 {/* Approval permission */}
//                 {(!hasCustomPermissions && (role === "admin" || role === "manager")) || 
//                  (hasCustomPermissions && can('AssetManagement', 'approve')) ? (
//                   <li>
//                     <Link
//                       href="/admins/assets/approval"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                 {/* Employee self-service */}
//                 {(!hasCustomPermissions && role !== "admin" && role !== "manager") || 
//                  (hasCustomPermissions && can('AssetManagement', 'myassets')) ? (
//                   <>
//                     <li>
//                       <Link
//                         href="/assets"
...
//           {shouldShow('Feedback') && 
//            ((!hasCustomPermissions && role === "admin") || 
//             (hasCustomPermissions && can('Feedback', 'manage'))) && (
//             <li>
//               <button
//                 onClick={() => toggleMenu("admin-panel")}
//                 aria-expanded={lastOpenedMenu === "admin-panel"}
...
//                 {/* Run */}
//                 {(!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && can('Payroll', 'run')) ? (
//                   <li>
//                     <Link
//                       href="/admins/payrolls"
//                       className={`py-2 px-4 rounded-lg flex items-center gap-2 transition-all duration-300 ${
...
//                 {/* Setup label */}
//                 {((!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && can('Payroll', 'setup'))) && (
//                   <>
//                     <li className="mt-2 mb-1 pl-2 text-xs font-semibold text-blue-200 uppercase">Setup</li>
...
//                       <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-payitems"] ? "block" : "hidden"}`}>
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'allowances')) ? (
//                           <li>
//                             <Link
//                               href="/master-data/allowances"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'deductions')) ? (
//                           <li>
//                             <Link
//                               href="/master-data/deductions"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                       <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-statutory"] ? "block" : "hidden"}`}>
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'epf')) ? (
//                           <li>
//                             <Link
//                               href="/master-data/epf"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'socso')) ? (
//                           <li>
//                             <Link
//                               href="/master-data/socso"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'eis')) ? (
//                           <li>
//                             <Link
//                               href="/master-data/eis"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'pcb')) ? (
//                           <li>
//                             <Link
//                               href="/master-data/pcb"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'taxreliefs')) ? (
//                           <li>
//                             <Link
//                               href="/master-data/reliefs"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                       <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-config"] ? "block" : "hidden"}`}>
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'allowancemapping')) ? (
//                           <li>
//                             <Link
//                               href="/admins/payroll-config-allowance"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'deductionmapping')) ? (
//                           <li>
//                             <Link
//                               href="/admins/payroll-config-deduction"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'config')) ? (
//                           <li>
//                             <Link
//                               href="/admins/payroll-config"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'policyassignment')) ? (
//                           <li>
//                             <Link
//                               href="/admins/payroll-policy-assignment"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'bankcurrency')) ? (
//                           <li>
//                             <Link
//                               href="/admins/bank-currency"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'overtime')) ? (
//                           <li>
//                             <Link
//                               href="/admins/overtime"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                       <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-overrides"] ? "block" : "hidden"}`}>
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'employeeallowances')) ? (
//                           <li>
//                             <Link
//                               href="/admins/employee-allowances"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'employeedeductions')) ? (
//                           <li>
//                             <Link
//                               href="/admins/employee-deductions"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                         ) : null}
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'employeereliefs')) ? (
//                           <li>
//                             <Link
//                               href="/admins/employee-reliefs"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                       <ul className={`menu menu-compact pl-6 ${openSubmenus["payroll-setup-claims"] ? "block" : "hidden"}`}>
//                         {(!hasCustomPermissions && role === "admin") || 
//                          (hasCustomPermissions && can('Payroll', 'claimbenefits')) ? (
//                           <li>
//                             <Link
//                               href="/admins/claim"
//                               className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//           {shouldShow('Claims') && 
//            ((!hasCustomPermissions && role !== "admin") || 
//             (hasCustomPermissions && !can('Claims', 'manage'))) && (
//             <li>
//               <Link
//                 href="/claims"
//                 className={`py-2 px-4 flex items-center rounded-lg transition-all duration-300 ${
...
//                 {/* Feedback System masters */}
//                 {((!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && hasAccess('MasterData'))) && (
//                   <>
//                     <li className="mt-4 mb-1 pl-2 text-xs font-semibold text-blue-200 uppercase">Feedback System</li>
//                     <li>
//                       <Link
...
//               <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "config-management" ? "block" : "hidden"}`}>
//                 {((!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && hasAccess('Configuration'))) && (
//                   <li>
//                     <Link
//                       href="/config/holiday"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//               <ul className={`menu menu-compact pl-8 ${lastOpenedMenu === "manage-admin" ? "block" : "hidden"}`}>
//                 {((!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && hasAccess('Admin'))) && (
//                   <li>
//                     <Link
//                       href="/admins"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                 )}
//                 {((!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && can('Admin', 'create'))) && (
//                   <li>
//                     <Link
//                       href="/admins/add"
//                       className={`py-2 px-4 rounded-lg transition-all duration-300 ${
...
//                 )}
//                 {((!hasCustomPermissions && role === "admin") || 
//                  (hasCustomPermissions && can('Admin', 'settings'))) && (
//                   <li>
//                     <Link
//                       href="/admin-settings"
//                       className={`px-4 py-3 rounded-lg transition-all duration-300 ${
